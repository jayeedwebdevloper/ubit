...
const MyProducts = () => {
    ...
    const { data: products = [], refetch } = useQuery({
        ...
        queryFn: async () => {
            const res = await fetch(`https://ubit-back-end.vercel.app/products/${user?.email}`);
    ...
    return (
        <div className='container mx-auto px-4 pb-5'>
            <h1 className='text-xl font-semibold text-gray-700'>My Products: {products.length}</h1>
                        ...
                        <tbody>
                            {
                                products.map((product, i) =>
                                    <tr key={product._id}>
                                        ...
                                        <td className='capitalize'><p>${product.regularPrice}</p></td>
                                        <td className='capitalize'><p>${product.price}</p></td>
