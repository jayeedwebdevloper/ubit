...
const Men = () => {
    ...
    return (
        <div className='container mx-auto px-4 pb-5'>
            <h1 className='text-xl font-semibold text-gray-700'>For Men's</h1>
            <div className="pt-8">
                        ...
                        products.map((product, i) =>
                            <div key={product._id} className="card shop-hover w-96 bg-base-100 shadow-xl relative overflow-hidden">
                                <figure className='h-64 relative'> <div className="front-hover">
                                    ...
                                    <img className='two absolute top-0 opacity-0 left-0 right-0 w-full' src={product.backPhoto} alt={product.productName} />
                                </div></figure>
